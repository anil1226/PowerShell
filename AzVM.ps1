...
For ($i = 1; $i -le 3; $i++) 
{
    ...
    New-AzVM -ResourceGroupName $resourceGroup -Name $vmName -Location 'East US' -Credential $adminCredential -OpenPorts 22,3389 -Image Win2019Datacenter -PublicIpAddressName $($vmName+'-ip')  
